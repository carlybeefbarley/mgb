        ...
        <div className={styles.section1}>
          <div className={styles.heroGrid}>
            <div className={styles.heroColumn}>
              <h1 className={styles.s1text}>MyGameBuilder v2</h1>
              <h3 className={styles.s1text}>Make Games. Make Friends. Have Fun.</h3>
          ...
          <div className={styles.listGrid}>
            <div className={styles.listColumn}>
              ...
              <ul className={styles.listUl}>
                <li className={styles.list}><span className={styles.iconList}><Icon size="1em" icon="check" /> </span>Online Editing</li>
