...
const AssetItems = ( { assets } ) => (
  <Card.Group style={_nowrapStyle}>
    ...
    { assets && assets.length && <div data-tooltip={`Only the ${_showLimit} most recently edited assets are shown here`} style={{ minWidth: '8em', textAlign: 'center', margin: 'auto' }}>. . .</div>}
  </Card.Group>
);
