        ...
        {this.options(
          ...
          () => {
            ...
            switch (parseInt(databag.all.actorType)) {
              case 4:
                databag.item.itemActivationType =
                  databag.item.itemActivationType !== '0' ? '0' : databag.item.itemActivationType
                break
              case 5:
                databag.item.itemActivationType =
                  ['4', '5', '6', '7'].indexOf(databag.item.itemActivationType) === -1
                    ? '4'
                    : databag.item.itemActivationType
                break
              case 6:
                databag.item.itemActivationType =
                  ['1', '2', '3'].indexOf(databag.item.itemActivationType) === -1
                    ? '3'
                    : databag.item.itemActivationType
                break
              case 7:
                databag.item.itemActivationType =
                  ['0', '8', '9'].indexOf(databag.item.itemActivationType) === -1
                    ? '0'
                    : databag.item.itemActivationType
            }
          },
