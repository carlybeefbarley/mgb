  ...
  render: function() {
    ...
    return (
      <div className="ui orange segment" style={{backgroundColor: "rgba(255, 165, 0, 0.06)"}}>
        ...
        { otherRefs === 1 ? 
          <p>There is 1 other reference to this variable/property.<br></br><span style={colorGrey}><small>Press CTRL-S to highlight it</small></span></p> : 
          <p>There are {otherRefs} other references to this variable/property.<br></br><span style={colorGrey}><small>Press CTRL-S to highlight them</small></span></p>
        }
        { def && def.start &&
          <p>
            ...
            <span style={colorGrey}><small>Press CTRL-B to jump there, and you can use Alt-, to jump back again</small></span>
          </p>
        }
        { origin && origin != "[doc]" && <p><small>Part of '{origin}'</small></p> }
      </div>
      )
  }
