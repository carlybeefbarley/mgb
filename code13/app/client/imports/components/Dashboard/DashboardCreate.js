    ...
    return (
      <Grid columns={16}>
        ...
        <Grid.Row stretched>
          <Grid.Column width={8}>
            <Segment>
              ...
              <br />
              <div>
                Skills completed <span style={{ fontSize: '32px' }}>32</span>, &nbsp;&nbsp;&nbsp; skills to
                complete <span style={{ fontSize: '32px' }}>156</span>, &nbsp;&nbsp;&nbsp; go to{' '}
                <Button primary>Next Skill</Button>
              </div>
              {userSkills && <SkillsMap skills={userSkills} skillPaths={['code.js']} expandable toggleable />}
            </Segment>
          </Grid.Column>
          <Grid.Column width={4}>
            <Segment>
              ...
              <List>
                <List.Item>
                  <QLink to={`/games`}>First link</QLink>
                </List.Item>
                <List.Item>
                  <QLink to={`/games`}>Second link</QLink>
                </List.Item>
                <List.Item>
                  <QLink to={`/games`}>Third link</QLink>
                </List.Item>
              </List>
            </Segment>
          </Grid.Column>
        ...
        <Grid.Row stretched>
          <Grid.Column width={16}>
            <Segment>
              <b>Liked games</b>
              <br />
              <ProjectsBeingMadeGET
                numEntries={6}
                chosenClassName="ui inverted very relaxed horizontal list"
              />
            </Segment>
          </Grid.Column>
        </Grid.Row>
        ...
        <Grid.Row stretched>
          ...
          <Grid.Column width={4}>
            <Segment>
              <b>MGB Announcements</b>
              <br />
              ActorMap game improvements The buttons for the actorMap game player have been simplified and
              have better help text. Frame rate is now locked to 30fps. Fixed bug with melee repeat modifier
            </Segment>
          </Grid.Column>
          <Grid.Column width={8}>
            <Segment />
