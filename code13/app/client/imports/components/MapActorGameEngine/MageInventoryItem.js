...
export default class InventoryItem
{
  ...
  get equippable()
  {
    return this.actor && (MgbActor.intFromActorParam(this.actor.content2.databag.item.inventoryEquippableYN) === 1)
  }
  ...
  get usable()
  {
    ...
    return (
      activation === MgbActor.alItemActivationType_PlayerPicksUpUsesLater && 
