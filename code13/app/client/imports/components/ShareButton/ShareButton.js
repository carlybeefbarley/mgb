      ...
      <div>
        ...
        <Form>
          <Input
            ...
            onChange={this.setNewUrl}
            fluid
            ref={this.handleInputRef}
          />
          <Form.TextArea autoHeight defaultValue={this.props.description} onChange={this.setNewDescription} />
        </Form>
      </div>
    )
  }
  ...
  render() {
    return (
      <Popup
        ...
        trigger={this.props.children ? React.cloneElement(this.props.children, {onClick: this.handleShareClick}) : <Button icon="share" onClick={this.handleShareClick} />}
