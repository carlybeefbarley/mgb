    ...
    return (
      <div>
        ...
        <p>
          ...
          <QLink to={`/u/${currUser.username}/skilltree`} style={{fontSize: '1.25em'}}>
            <span style={{position: 'relative', top: 0}}>My Skills</span>
          </QLink>
          <br />
          <small><i>&emsp;...This area summarizes learning progress via tutorials, muted help, assessed tasks etc..</i></small>
        </p>
