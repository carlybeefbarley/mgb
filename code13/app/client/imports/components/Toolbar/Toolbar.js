...
Toolbar.propTypes = {
  ...
  level:     PropTypes.number            , // Default level if not specified in the user settingsnowrap:    PropTypes.bool               // For mobile, allow nowrap so it scrolls horizontally to save vertical space
}
