...
const NoBadgesMsg = ( { ownsProfile } ) => (
  <span>
    No badges yet.
    { ownsProfile &&
      <span> Earn your first badge by trying the <QLink to='/learn/getStarted'>Get Started</QLink> tutorials!</span>
    }
  </span>
)
  ...
  return (
    <div className={className}>
      ...
      <div id='#mgbjr-profile-badges-area'>
        ...
        { (!uBadges || uBadges.length === 0) &&
          <NoBadgesMsg ownsProfile={ownsProfile} />
        }
      </div>
    </div>
  )
