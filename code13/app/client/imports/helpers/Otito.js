'use strict'
var Otito = function(obj, meta, cb = void 0, options = Otito.options, parent = void 0) {
  this.object = obj || {}
    ...
    for (i = 0; i < keys.length; i++) {
      ...
      if (meta._type) {
        if (meta._type == 'folder') {
          ...
          var cls = (this.options.folderClassName +
            ' ' +
            (meta.className ? meta.className : '') +
            ' ' +
            (meta.__className ? meta.__className : '')).split(' ')
          cls.forEach(c => {
            c && f.body.classList.add(c)
          })
          //f.body.className
  ...
  _buildArray: function() {
    ...
    for (i = 0; i < this.object.length; i++) {
      rec = this._updateObjectRecord(
        ...
        i,
        this.object[i],
        Otito.FLAGS.DYNAMIC | Otito.FLAGS.HEADLESS,
      )
    }
