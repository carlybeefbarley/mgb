...
const LegalSection = (props) => (
  <div>
    <Header as='h3' content={props.banner} />
...
export default TermsOfService = () => ( 
  <Container>
    ...
    <LegalSection banner='Terms of Service' >
      <Table.Row>
        <Table.Data>
          ...
          Service. If you do not agree to these Terms of Service or any part thereof, your
          only remedy is to not use the {thisSiteName_Site} or any services or products offered
          on the {thisSiteName_Site} or on any other platform, including mobile applications,
          offered by {companyName} (collectively, the “Service” or “Services”). VIOLATION OF ANY
          OF THE TERMS OF SERVICE BELOW WILL RESULT IN THE TERMINATION OF YOUR RIGHT TO
          USE THE SERVICE, AND ANY ACCOUNT THAT YOU MAY HAVE CREATED AS PART OF THE
          SERVICE. YOU AGREE TO USE THE SERVICE AT YOUR OWN RISK. {companyName} reserves the
          right to refuse service to anyone for any reason at any time.
        </Table.Data>
        <Table.Data>
          By being a member and using {thisSiteName}, you agree to everything on this page. We
          have to do this to protect both you and us and make running this business
          possible. If you break these terms, you can't use {thisSiteName} anymore.
        </Table.Data>
      </Table.Row>
    </LegalSection>
    ...
    <LegalSection banner='Your Account'>
      <Table.Row>
        <Table.Data>
          In order to open an account on the {thisSiteName_Site} (the “<strong>Account</strong>”),
          you must (i) agree to these Terms of Service, and (ii) provide any other
          information required by {companyName} during the registration process. You will update
          this information to maintain its accuracy during the time you are using the
          Service. You are responsible for maintaining the security of your account and
          password. {companyName} cannot and will not be liable for any loss or damage from your
          failure to comply with this security obligation. You are also responsible for
          all content, code, features, comments, graphics or text that you may post on the
        ...
        <Table.Data>
          Your account is your responsibility. If your account is compromised we'll try to
          help, but we can't guarantee we can fix any damages.
        </Table.Data>
      </Table.Row>
    </LegalSection>
    ...
    <LegalSection banner='Our License to You' >
      <Table.Row>
        <Table.Data>
          {companyName} hereby grants you a non-exclusive, non-transferable, worldwide right to
          access and use the {thisSiteName_Site}, solely with supported browsers through the
          Internet for your own internal purposes, subject to these Terms of Service. You
          may not permit the {thisSiteName_Site} to be used by or for the benefit of unauthorized
          third parties. Nothing in the Terms of Service shall be construed to grant you
          any right to transfer or assign rights to access or use the {thisSiteName_Site}. All
          rights not expressly granted to you are reserved by {companyName} and its licensors.
          You shall not (i) modify or make derivative works based upon the {thisSiteName_Site};
          (ii) reverse engineer or access the {thisSiteName_Site} in order to (a) build a
    ...
    <LegalSection banner='Your License to Us'>
      ...
      <Table.Row>
        <Table.Data>
          You agree that this license includes the right for {companyName} and other users of
          the Services to make your Content available to others for the publication,
          distribution, syndication, or broadcast of such Content on other media and
          services, subject to our terms and conditions for such Content use. Such
          additional uses by {companyName} or others may be made with no compensation paid to
      ...
      <Table.Row>
        <Table.Data>
          {companyName} may modify or adapt your Content in order to transmit, display or
          distribute it over computer networks and in various media and/or make changes to
          your Content as are necessary to conform and adapt that Content to any
      ...
      <Table.Row>
        <Table.Data>
          ...
          the trade secret belongs to you or you have the owner's permission to disclose
          it, (c) infringes any intellectual property right of another or the privacy or
          publicity rights of another, (d) is libelous, defamatory, abusive, threatening,
          harassing, hateful, offensive or otherwise violates any law or right of any
          third party, (e) creates an impression that you know is incorrect, misleading,
          or deceptive, including by impersonating others or otherwise misrepresenting
          your affiliation with a person or entity; (f) contains other people's private or
          personally identifiable information without their express authorization and
          permission, and/or (g) contains or links to a virus, trojan horse, worm, time
          ...
          system, data or information. {companyName} reserves the right in its discretion to
          remove any Content from the {thisSiteName_Site}, suspend or terminate your account at
      ...
      <Table.Row>
        <Table.Data>
          You are responsible for your use of the Service, for any Content you provide,
          and for any consequences thereof, including the use of your Content by other
          users and third party partners. You understand that your Content may be
          republished and if you do not have the right to submit Content for such use, it
          may subject you to liability. {companyName} will not be responsible or liable for any
          use of your Content in accordance with these Terms of Service.
        </Table.Data>
        <Table.Data>
          Don't use {thisSiteName} to do bad things. If you do, we'll remove your account and you
          personally are responsible for any trouble you cause.
        </Table.Data>
      </Table.Row>
    </LegalSection>
    ...
    <LegalSection banner='Your Responsibilities' >
      <Table.Row>
        ...
        <Table.Data>
          ...
          legally binding and you have to be {ageMinimumToJoin} or older for that to be possible.
        </Table.Data>
      </Table.Row>
      <Table.Row>
        <Table.Data>
          {companyName} relies upon parents or guardians {ageMinimumToJoin} years of age or older to determine
          if the {thisSiteName_Site} and Services are appropriate for the viewing, access, or
          participation by such individuals under the age of {ageMinimumToJoin}. We do not seek or
          knowingly collect any personal information about children under {ageMinimumToUse} years of age.
          If we become aware that we have unknowingly collected personal information from
          a child under the age of {ageMinimumToUse}, we will make commercially reasonable efforts to
          delete such information from our database.
        </Table.Data>
        <Table.Data>
          If you are under {ageMinimumToUse}, you can't use {thisSiteName} (sorry).<br/>
          If you are {ageMinimumToUse} or over but under {ageMinimumToJoin}, have your legal guardian sign up for you.
        </Table.Data>
      </Table.Row>
      <Table.Row>
        <Table.Data>
          ...
          registration forms, when registering for or using the Services and (b) update
          and maintain the truthfulness, accuracy and completeness of such information.
        </Table.Data>
        <Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          You are responsible for all activity occurring under your Accounts and are
          solely responsible for compliance with all applicable local, state, national and
          foreign laws, treaties and regulations relating to your use of the {thisSiteName_Site},
      ...
      <Table.Row>
        <Table.Data>
          ...
          known or suspected breach of security; and (ii) report to {companyName} immediately
          and use reasonable efforts to stop immediately any copying or distribution of
          Content that is known or suspected by you.
        </Table.Data>
        <Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          You are responsible for obtaining and maintaining any equipment and ancillary
          services needed to connect to, access or otherwise use the {thisSiteName_Site},
          including, without limitation, modems, hardware, server, software, Internet
          browsers operating system, networking, web servers, long distance and local
          telephone service, but excluding the {thisSiteName_Site} itself (collectively, “<strong>Equipment</strong>”).
          You shall be responsible for ensuring that such Equipment is compatible with the
          {thisSiteName_Site}. You shall also be responsible for the use, and maintaining the
      ...
      <Table.Row>
        <Table.Data>
          ...
          responsibility of the person who originated such Content. We may not monitor or
          control the Content posted via the Services. Any use of or reliance on any
          Content or materials posted via the Services or obtained by you through the
          Services is at your own risk. We do not endorse, support, represent or guarantee
          ...
          Content that might be offensive, harmful, inaccurate or otherwise inappropriate.
          Under no circumstances will {companyName} be liable in any way for any Content,
          including, but not limited to, any errors or omissions in any Content, or any
          loss or damage of any kind incurred as a result of the use of any Content made
    ...
    <LegalSection banner='Impermissible Acts' extraText={`As a condition to your use of the ${thisSiteName_Site}, you agree not to:`} >
      <Table.Row>
        <Table.Data>
          upload, post, email, transmit or otherwise make available any information,
          materials or other content that is illegal, harmful, threatening, abusive,
          harassing, defamatory, obscene, pornographic, offensive, invades another’s
          privacy, or promotes bigotry, racism, hatred or harm against any individual or
          group;
        </Table.Data>
        <Table.Data>
          <DBAJ />
      ...
      <Table.Row>
        <Table.Data>
          phish, collect, upload, post, email, transmit or otherwise make available any
          login data and/or passwords for other web sites, software or services;
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          phish, collect, upload, post, email, transmit or otherwise make available credit
          card information or other forms of financial data used for collecting payments;
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          ...
          origin of any content transmitted through the {thisSiteName_Site};
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          upload, post, email, transmit or otherwise make available any information,
          materials or other content that infringes another’s rights, including any
      ...
      <Table.Row>
        <Table.Data>
          use any manual or automated software, devices, or other processes to “crawl,”
          “spider” or “screen scrape” any web pages contained in the {thisSiteName_Site};
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          reverse engineer, decompile or disassemble any of the software used to provide
          the {thisSiteName_Site};
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          reproduce, duplicate or copy or exploit any other portion of the {thisSiteName_Site},
          without the express written permission of {companyName};
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          interfere with or disrupt the {thisSiteName_Site}, or any servers or networks connected
          to the {thisSiteName_Site}, or disobey any requirements, procedures, policies or
          regulations of networks connected to the {thisSiteName_Site};
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          modify, adapt or hack the {thisSiteName_Site} or falsely imply that some other site is
          associated with the {thisSiteName_Site} or {companyName}; or
        </Table.Data>
        <Table.Data>
          <DBAJ />
        </Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          use the {thisSiteName_Site} for any illegal or unauthorized purpose. You must not, in
          the use of the {thisSiteName_Site}, violate any laws in your jurisdiction (including
      ...
      <Table.Row>
        <Table.Data>
          ...
          refuse to distribute any Content on the Service and to terminate users or
          reclaim usernames. We also reserve the right to access, read, preserve, and
          disclose any information as we reasonably believe is necessary to (i) satisfy
          any applicable law, regulation, legal process or governmental request, (ii)
          enforce the Terms of Service, including investigation of potential violations
          hereof, (iii) detect, prevent, or otherwise address fraud, security or technical
    ...
    <LegalSection banner='Feedback'>
      <Table.Row>
        <Table.Data>
          ...
          defects regarding the {thisSiteName_Site} (collectively “<strong>Feedback</strong>”).
          You hereby grant {companyName} a worldwide, irrevocable, perpetual, royalty-free,
          transferable and sub-licensable, non-exclusive right to use, copy, modify,
    ...
    <LegalSection banner='Violation of these Terms of Service' >
      <Table.Row>
        <Table.Data>
          {companyName} reserves the right to investigate and prosecute violations of any of
          these Terms of Service to the fullest extent of the law. {companyName} may involve and
          cooperate with law enforcement authorities in prosecuting users who violate the
          Terms of Service. You acknowledge that {companyName} has no obligation to pre-screen
          or monitor your access to or use of the {thisSiteName_Site} or any information,
          materials or other content provided or made available through the {thisSiteName_Site},
          but has the right to do so. You hereby agree that {companyName} may, in the exercise
          of {companyName} sole discretion, remove or delete any entries, information,
          materials or other content that violates these Terms of Service or that is
          otherwise objectionable.
        </Table.Data>
        <Table.Data>
          We will delete anything that violates these rules. We have the right to take
          legal action against violations of these rules.
        </Table.Data>
      </Table.Row>
    </LegalSection>
    ...
    <LegalSection banner='Cancellation and Termination'>
      ...
      <Table.Row>
        <Table.Data>
          Any cancellation of your Account will result in the deactivation or deletion of
          your Account or your access to your Account, and the forfeiture and
          relinquishment of all Content in your Account. This information cannot be
          recovered from {companyName} once your Account is cancelled. Please be aware that
          {companyName} may for a time retain residual information in our backup and/or archival
          copies of our database. We will make reasonable commercial efforts to delete
      ...
      <Table.Row>
        <Table.Data>
          {companyName}, in its sole discretion, has the right to suspend or terminate your
          Account if (1) you breach these Terms of Service or (2) your bandwidth usage
          significantly exceeds the average bandwidth of other users of the Service. In
          each such case {companyName} may refuse to provide you any current or future use of
          the {thisSiteName_Site}, or any other Service. Any termination of your Account will
          ...
          This information cannot be recovered from {thisSiteName} once your account is
          terminated; however {companyName} may for a time retain residual information in our
    ...
    <LegalSection banner={`Modifications to the ${thisSiteName_Site} and Prices`} >
      <Table.Row>
        <Table.Data>
          {companyName} reserves the right at any time and from time to time to modify or
          discontinue, temporarily or permanently, the {thisSiteName_Site} and Service (or any
      ...
      <Table.Row>
        <Table.Data>
          ...
          price change, suspension or discontinuance of the {thisSiteName_Site}.
        </Table.Data>
        <Table.Data>
          Hopefully any change we make to the site is for the better, but if we change
          something you don't like, it will be up to you to decide if you want to stay.
        </Table.Data>
      </Table.Row>
      <Table.Row>
        <Table.Data>
          {companyName} reserves the right to update and change the Terms of Service from time
          to time without notice. Any new features that augment or enhance the current
          {thisSiteName_Site}, including the release of new tools and resources, shall be subject
          to the Terms of Service. Continued use of the {thisSiteName_Site} after any such
    ...
    <LegalSection banner='Copyright and Content Ownership'>
      <Table.Row>
        <Table.Data>
          ...
          provided by you), are and will remain the exclusive property of {companyName} and its
          licensors. The Services are protected by copyright, trademark, and other laws of
          both the United States and foreign countries. Nothing in the Terms of Service
          gives you a right to use the {thisSiteName} name or any of the {companyName} trademarks,
          logos, domain names, and other distinctive brand features. You acknowledge that
          the ownership in any intellectual property rights (including, for the avoidance
          of doubt, patents, copyright, rights in databases, trademarks and trade names
          whether registered or unregistered and subsisting anywhere in the world) in the
          Services belongs to {companyName} or its third party licensors. Accordingly, any part
          of the Services may not be used, transferred, copied or reproduced in whole or
    ...
    <LegalSection banner='Notification of Claims of Infringement' >
      <Table.Row>
        <Table.Data>
          ...
          violated, please notify {companyName}'s' agent for notice of claims of copyright or
          ...
          <ul>
            <li>
              Identification of the material on the {thisSiteName_Site} that you claim is infringing,
              with enough detail so that we may locate it on the {thisSiteName_Site};
            </li>
            <li>
              ...
              information in your notice is accurate, and (2) that you are the owner of the
    ...
    <LegalSection banner='Disclaimer of Warranties' >
      <Table.Row>
        <Table.Data>
          ...
          {thisSiteName_SiteCAPS} ARE PROVIDED ON AN “AS IS” AND “AS AVAILABLE” BASIS, WITH NO
          WARRANTIES WHATSOEVER. {companyNameCAPS} AND ITS LICENSORS EXPRESSLY DISCLAIM TO THE
          FULLEST EXTENT PERMITTED BY LAW ALL EXPRESS, IMPLIED, AND STATUTORY WARRANTIES,
          INCLUDING, WITHOUT LIMITATION, THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A
          PARTICULAR PURPOSE, AND NON-INFRINGEMENT OF PROPRIETARY RIGHTS. {companyNameCAPS} AND ITS
          LICENSORS DISCLAIM ANY WARRANTIES REGARDING THE SECURITY, RELIABILITY,
          TIMELINESS, AND PERFORMANCE OF THE SERVICES. {companyNameCAPS} DOES NOT WARRANT THAT (I)
          THE SERVICE WILL MEET YOUR SPECIFIC REQUIREMENTS, (II) THE SERVICE WILL BE
          ...
          ERRORS IN THE {thisSiteName_SiteCAPS} WILL BE CORRECTED. {companyNameCAPS} AND ITS LICENSORS
          DISCLAIM, ANY WARRANTIES FOR ANY INFORMATION, CONTENT OR ADVICE OBTAINED THROUGH
          THE SERVICES. {companyNameCAPS} AND ITS LICENSORS DISCLAIM ANY WARRANTIES FOR SERVICES OR
          GOODS RECEIVED THROUGH OR ADVERTISED ON THE {companyNameCAPS} SERVICES OR RECEIVED THROUGH
          ANY LINKS PROVIDED BY THE {thisSiteName_SiteCAPS}.
        </Table.Data>
        <Table.Data>
          There might be downtime. There might be bugs. The features might not always meet
          your exact needs.
        </Table.Data>
      </Table.Row>
      <Table.Row>
        <Table.Data>
          ...
          AND THE SERVICE IS AT YOUR OWN DISCRETION AND RISK AND THAT YOU WILL BE
          SOLELY RESPONSIBLE FOR LOSS OF DATA THAT RESULTS FROM THE SUBMISSION OR DOWNLOAD
          OF SUCH CONTENT.
        </Table.Data>
        <Table.Data>
    ...
    <LegalSection banner='Limitation of Liability' >
      <Table.Row>
        <Table.Data>
          UNDER NO CIRCUMSTANCES SHALL {companyNameCAPS} OR ITS LICENSORS BE LIABLE TO YOU ON
          ACCOUNT OF THAT USER’S USE OR MISUSE OF OR RELIANCE ON THE SERVICES OR {thisSiteName_SiteCAPS}
          ...
          OR OTHERWISE, (EVEN IF {companyNameCAPS} OR ITS LICENSORS HAVE BEEN ADVISED OF THE
          POSSIBILITY OF SUCH DAMAGES). SUCH LIMITATION OF LIABILITY SHALL APPLY WHETHER
          THE DAMAGES ARISE FROM USE OR MISUSE OF AND RELIANCE ON THE SERVICES OR {thisSiteName_SiteCAPS},
          FROM INABILITY TO USE THE SERVICES OR {thisSiteName_SiteCAPS}, OR FROM THE
          INTERRUPTION, SUSPENSION, OR TERMINATION OF THE SERVICES OR {thisSiteName_SiteCAPS}
      ...
      <Table.Row>
        <Table.Data>
          ...
          NON-PERFORMANCE OF THE SERVICES OR {thisSiteName_SiteCAPS} OR ANY INFORMATION OR
          MERCHANDISE THAT APPEARS ON, OR IS LINKED OR RELATED IN ANY WAY TO, THE {companyNameCAPS}
          SERVICES. SUCH LIMITATION SHALL APPLY NOTWITHSTANDING ANY FAILURE OF ESSENTIAL
          PURPOSE OF ANY LIMITED REMEDY AND TO THE FULLEST EXTENT PERMITTED BY LAW.
        </Table.Data>
        <Table.Data>
          For example, if you try and somehow run a business through {thisSiteName} and we have
          some downtime, we can't be responsible for your loss of profit.
        </Table.Data>
      </Table.Row>
      <Table.Row>
        <Table.Data>
      ...
      <Table.Row>
        <Table.Data>
          Without limiting the foregoing, under no circumstances shall {companyName} or its
    ...
    <LegalSection banner='Indemnification'>
      <Table.Row>
        <Table.Data>
          ...
          liabilities incurred through the use of the Services. To the maximum extent
          permitted by applicable law, you agree to hold harmless and indemnify {companyName}
          ...
          attorneys' fees, of every kind and nature including but not limited to any
          ...
          shall use good faith efforts to provide you with written notice of such claim,
          suit or action. In addition, you expressly waive and relinquish any and all
          rights and benefits which you may have under any other state or federal statute
          or common law principle of similar effect, to the fullest extent permitted by
          law.
        </Table.Data>
        <Table.Data>
          If you get in trouble with the law for something you did on {thisSiteName}, that's on
          you and you agree that it isn't {companyName} itself's fault. If we receive
          notification of an infringement by you, we'll pass it along to you. You're welcome!
        </Table.Data>
      </Table.Row>
    </LegalSection>
    ...
    <LegalSection banner='General' >
      <Table.Row>
        <Table.Data>
          ...
          provisions or your actual state or country of residence. If for any reason a
          court of competent jurisdiction finds any provision or portion of the Terms of
          Service to be unenforceable, the remainder of the Terms of Service will continue
          in full force and effect. These Terms of Service constitute the entire agreement
          between the parties with respect to the subject matter hereof and supersedes and
          replaces all prior or contemporaneous understandings or agreements, written or
          oral, regarding such subject matter (including, but not limited to, any prior
          versions of the Terms of Service). Any waiver of any provision of the Terms of
        ...
        <Table.Data>
          If part of these terms are in conflict with laws in your region, the rest of the
          terms still apply. Any questions, just ask us.
        </Table.Data>
      </Table.Row>
    </LegalSection>
