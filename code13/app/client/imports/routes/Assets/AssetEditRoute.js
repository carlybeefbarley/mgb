          ...
          (projectName !== __NO_PROJECT__ && (
            <div style={{ position: 'absolute', top: 0, right: 0, padding: '0.5em' }}>
              <Modal
                ...
                trigger={<Button icon compact size="tiny" title="create new asset" onClick={this.handleOpenCreateNewAssetModal} disabled={!canCreate}><Icon color="green" name="add"/></Button>
                }
              >
                <Modal.Content>
