    ...
    return (
      <div>
        <div className="ui container">
          <div className="ui grid stackable" style={{marginTop: '4.5em', marginBottom: '4.5em'}}>
            <div className="row">
              <div className="ten wide column">
                <h1 className="ui huge header" style={{fontSize: '3em'}}>
                  My Game Builder
                  <em className="sub header">The Online Game-building Game</em>
                </h1>
                ...
                <p style={{fontSize: '1.5em', marginTop: '1.75em'}}>
                  ...
                  <br />
                  <button className="ui primary large button" style={{marginTop: '1em'}}>Sign me up</button>
                </p>
              </div>
            </div>
