...
export default NotYetImplementedRoute = ( { currUser, params } ) => (
  <div>
    <Segment className="vertical masthead center aligned">
      <Container text>
        ...
        <Message warning icon='warning sign' compact header='Soon, soon!' content={`We are hard at work on '${params.featureName}'`} />
        <Divider clearing />
        { currUser ?
