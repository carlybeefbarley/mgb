...
const ProjectForkGenerator = ( { project, isForkPending } ) => {
  ...
  const children = _.reverse(_.map(project.forkChildren, f => { 
  ...
  return (
    <Popup
        ...
        <Popup.Content>
          <Segment basic>
            Project Forks are copies of an existing Project (and all Assets in that Project) 
            where the 'parent-to-child' chain is tracked.
          </Segment>
            ...
            { fpLen === 0 ? (
                <div>
                  ...
                  <div>
                    &emsp;Not forked from another Project within this system
                  </div>
                </div>
              ) : (
                <div>
                  ...
                  <div>
                    { _.reverse(_.map(project.forkParentChain, (fp, idx) => (
          ...
          <div style={{marginTop: '1em', maxHeight: '200px', overflow: 'scroll'}}>
            <b><Icon name='fork'/>{ numChildren } Forks of this project:</b>
