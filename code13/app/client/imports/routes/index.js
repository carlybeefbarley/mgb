...
// 1) All /users/:id are legacy and should be removed soon (superceded July 6 2016)
...
export function clientStartup() {
        ...
        render={props => (
          <App {...props}>
            ...
            <Route
              ...
              component={Users.SignupEducationRoute}
              name="Educational Signup"
            />
  ...
  registerDebugGlobal('router', AppRouter, __filename, 'TopLevel react-router instance')
  urlMaker.setKnownRoutes(AppRouter)
  return AppRouter
}
