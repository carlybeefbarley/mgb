...
export const skillAreaItems = [
  { tag: 'code',       mascot: 'alien',      icon: 'code',        title: 'Programming',   desc: 'Code using JavaScript and game engines like Phaser' },
  { tag: 'art',        mascot: 'penguin',    icon: 'paint brush', title: 'Pixel art',     desc: 'Create animated sprites, spritesheets and tilemaps for games' },
  { tag: 'audio',      mascot: 'samurai',    icon: 'music',       title: 'Music & audio', desc: 'Bring engagement and mood to games through music and sound' },
