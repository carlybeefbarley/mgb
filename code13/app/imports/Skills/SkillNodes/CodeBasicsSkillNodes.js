...
export default {
  ...
  divideDecimal: {
    $meta: {
      ...
      code: ["var quotient = 0.0 / 2.0; // Fix this line", "", ""],
      solutions: [],
      tests: [
  ...
  findingRemainder: {
    $meta: {
      ...
      code: ["// Only change code below this line", "", "var remainder;", ""],
  ...
  returnValue: {
    $meta: {
      ...
      solutions: ["function timesFive(num) {\n  return num * 5;\n}"],
      tests: [
  ...
  ternaryOperator: {
    $meta: {
      ...
      code: ["function checkEqual(a, b) {", "  ", "}", "", "checkEqual(1, 2);"],
      solutions: [],
      tests: [
  ...
  multipleTernaryOperators: {
    $meta: {
      ...
      code: ["function checkSign(num) {", "  ", "}", "", "checkSign(10);"],
      solutions: [],
      tests: [
