...
export default {
    ...
    'gameplay': { // ludology.  Fancy word for the study of gameplay.  What's a game, what isn't?
    ...
    'game-mechanics': {
        ...
        'metagame and core game mechanics': { // specific examples of mechanics that illustrate different balance issues.
            'symmetric balance': { // games where each choice is functionally the same, although the fluffy bits may vary 
            ...
            'risk vs reward': { // discussion of how to use risk and reward mechanisims to motivate player behavior.
            ...
            'other game mechanics': {
                ...
                'comprehensive list': { // a cheat sheet for mechanics, including short descriptions of ones we don't go into detail on.
        ...
        'common game mechanics': { // these show up with alarming frequency in some form in most games.
            'health': { // the arbitrary hit point?
                'initial health': C.E,
                'max health': C.E,
                'recovery rates': C.E,
                'healing': C.E,
            ...
            'combat': { // what combat subsystem do you want to design?  How do you balance it?
                'melee': C.E,
                'touch-damage': C.E,
                'shots': C.E,
                'direct-damage': C.E,
            ...
            'defense': { // how to balance tanks with damage dealers.  Is it fun for everyone?
                'armor': C.E,
                'agility': C.E,
                'stealth': C.E,
                'invulnerability': C.E
            ...
            'in-game-rewards': {
                ...
                'character improvement': { // only 200 more rats and I hit level 2!
    ...
    'level design': { // a part of the whole.
        ...
        'level contents': { // what assest are going to be in your level?
            'enemies': C.E,
            'allies': C.E,
            'hazards': C.E,
            'loot': C.E,
