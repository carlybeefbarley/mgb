// This is just the same content as node_modules/tern/defs/ecma5.json
// It is included here so it can be compressed and be part of the normal bundle. 
// It has been changed to be in ES6 module format

export default DefsEcma5 = {
  "!name": "ecma5",
