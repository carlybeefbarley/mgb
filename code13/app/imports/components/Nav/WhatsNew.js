...
export default WhatsNew = React.createClass({
  ...
  render: function() 
  {
    ...
    if (this.props.asHidingLink)
      return laterNewsAvailable && <QLink to="/whatsnew" className="fitted item" style={{paddingLeft: "12px", marginTop: "-4px"}}><i className={"circular inverted yellow announcement icon"}></i></QLink>
