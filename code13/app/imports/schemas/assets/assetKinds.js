...
export const AssetKinds = {
  ...
  graphic: {
    name: 'Graphic',
    selfPlural: false,
    disable: SpecialGlobals.isAssetDisabled['graphic'],
    longName: 'Graphic',
    icon: 'image',
    color: 'orange',
    requiresUserRole: null,
  ...
  actor: {
    name: 'Actor',
    selfPlural: false,
    disable: SpecialGlobals.isAssetDisabled['actor'],
    longName: 'Actor',
    icon: 'child',
    color: 'teal',
    requiresUserRole: null,
  ...
  actormap: {
    name: 'ActorMap',
    selfPlural: false,
    disable: SpecialGlobals.isAssetDisabled['actormap'],
  ...
  map: {
    name: 'Map',
    selfPlural: false,
    disable: SpecialGlobals.isAssetDisabled['map'],
  ...
  sound: {
    name: 'Sound',
    selfPlural: true,
    disable: SpecialGlobals.isAssetDisabled['sound'],
    longName: 'Sound',
    icon: 'volume up',
    color: 'pink',
    requiresUserRole: null,
  ...
  music: {
    name: 'Music',
    selfPlural: true,
    disable: SpecialGlobals.isAssetDisabled['music'],
    longName: 'Music',
    icon: 'music',
    color: 'blue',
  ...
  code: {
    name: 'Code',
    selfPlural: true,
    disable: SpecialGlobals.isAssetDisabled['code'],
  ...
  game: {
    name: 'GameConfig',
    selfPlural: false,
    disable: SpecialGlobals.isAssetDisabled['game'],
  ...
  tutorial: {
    name: 'Tutorial',
    selfPlural: false,
    disable: SpecialGlobals.isAssetDisabled['tutorial'],
