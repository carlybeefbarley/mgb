...
export const FlagTypes = {
  ...
  "abuse.spam.advert":      {displayName: "spam advertising", description: "Actions, messages, images, videos, or references that are considered spam/promotional according to MGB community rules."},
  "abuse.spam.porno":       {displayName: "spam pornographic", description: "Actions, messages, images, videos, or references that are considered spam/pornogrpahic according to MGB community rules."},
  "abuse.spam.malware":     {displayName: "spam malware/phishing", description: "Actions, messages, images, videos, or references that are considered spam/malware according to MGB community rules."},
