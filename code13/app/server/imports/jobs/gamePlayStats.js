...
Meteor.methods({
  'job.gamePlayStats.playGame': function( assetId ) {
    ...
    console.log('[PlayGame]  Request To Increment PlayCount for ', assetId, username, this.connection.clientAddress)
    ...
    if (game.kind !== 'game')
      throw new Meteor.Error(404, 'Asset is not a game object')
    ...
    console.log(`  [PlayGame]  (${recordsUpdated})  #${assetId}  Owner=${game.dn_ownerName}  NewPlayCount=${newPlayCount}`) 
